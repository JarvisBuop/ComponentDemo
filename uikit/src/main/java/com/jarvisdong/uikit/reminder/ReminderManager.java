...
public class ReminderManager {
    ...
    public final void upDateUnReadNum(int unread, boolean isCover, int reminderId, boolean indicator) {
        updateUnreadMessageNum(unread, !isCover, reminderId, indicator);
    }
    ...
    private final void updateUnreadMessageNum(int unreadNum, boolean delta, int reminderId) {
        ReminderItem item = getRemindItem(reminderId);
    ...
    private final void updateUnreadMessageNum(int unreadNum, boolean delta, int reminderId, boolean indicator) {
        ReminderItem item = getRemindItem(reminderId);
        item.setIndicator(indicator);
        updateUnreadMessageNum(unreadNum, delta, reminderId);
    }

    private ReminderItem getRemindItem(int reminderId) {
