...
public class HeaderAndFooterWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public boolean isOriginDataEmpty() {
        if (mInnerAdapter instanceof EmptyWrapper) {
            return ((EmptyWrapper) mInnerAdapter).isOriginDataEmpty();
        }
    ...
    public void notifyItemRangeRemovedWrapper(int position, int count) {
        notifyItemRangeRemoved(position + getHeadersCount(), count);
    }

    public void notifyItemRangeChangedWrapper(int positionStart, int itemCount) {
        notifyItemRangeChanged(positionStart + getHeadersCount(), itemCount - positionStart - getHeadersCount());
    }
