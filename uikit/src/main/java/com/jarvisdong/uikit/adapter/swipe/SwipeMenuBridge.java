 ...
 */
package com.jarvisdong.uikit.adapter.swipe;
...
public final class SwipeMenuBridge {
    ...
    @SwipeAdapterWrapper.DirectionMode
    ...
    SwipeMenuBridge(@SwipeAdapterWrapper.DirectionMode int direction, int position, SwipeSwitch swipeSwitch, View viewRoot) {
