...
public class FileUtil {
    ...
    public static String PATH_IMGCACHE = "IMGCache/";
    ...
    public static File getIMGCacheDir(String filePath){
        if (Environment.getExternalStorageState().equals(
                Environment.MEDIA_MOUNTED)) { // 文件可用
            File dirs = new File(getAvailableCacheDir(),
                    filePath);
            if (!dirs.exists())
                dirs.mkdirs();
            return dirs;
    ...
    public static File getIMGCacheFile(String filePath, String imageName) {
        if (Environment.getExternalStorageState().equals(
                Environment.MEDIA_MOUNTED)) { // 文件可用
            File dirs = new File(getAvailableCacheDir(),
                    filePath);
            ...
            File file = new File(getAvailableCacheDir(),
                    filePath + imageName);
            if (!file.exists()) {
                try {
                    //在指定的文件夹中创建文件
